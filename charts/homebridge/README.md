...
![Version: 4.2.1](https://img.shields.io/badge/Version-4.2.1-informational?style=flat-square) ![AppVersion: 4.0.0](https://img.shields.io/badge/AppVersion-4.0.0-informational?style=flat-square)
...
helm repo update
helm install homebridge jr0dd/homebridge
```
...
```console
helm install homebridge jr0dd/homebridge -f values.yaml
```
